...
SRC_URI = " git://github.com/nxp-imx/uboot-imx.git;protocol=https;branch=${SRCBRANCH} \
            ...
            file://0002-patch_uboot_5.10.72_1.0.5-1.1.0.patch \
            file://0003-UBI-FAST-MAP-speed-up-boot.patch \
            file://0004-V1.0.6.patch \
            file://0005-V1.0.8.-Fix-2GB-4GB-compatible.patch \
"

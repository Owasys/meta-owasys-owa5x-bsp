...
do_compile() {
    ...
    for target in ${IMXBOOT_TARGETS}; do
        ...
        if [ -e "${BOOT_STAGING}/flash.bin" ]; then
            ...
            bbnote "Copied flash.bin from ${BOOT_STAGING}/ to ${DEPLOY_DIR_IMAGE}/${MACHINE}-flash.bin"
        fi
    done
}
...
do_clean_final_binary () {
    rm ${DEPLOY_DIR_IMAGE}/${MACHINE}-flash.bin
}

addtask clean_final_binary before do_clean after do_compile

...
# Adding device partition
    ...
    ln -sf ${IMAGE_NAME}${vname}-${UBI_ROOTFS_VOL_NAME}.ubifs ${IMAGE_LINK_NAME}-${UBI_ROOTFS_VOL_NAME}.ubifs
    ln -sf ${IMAGE_NAME}${vname}.${UBI_ROOTFS_VOL_NAME}.tar.gz ${IMAGE_LINK_NAME}-${UBI_ROOTFS_VOL_NAME}.tar.gz
}

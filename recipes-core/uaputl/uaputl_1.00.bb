DESCRIPTION = "uaputl - This tool can be used to set/get uAP's settings."
SECTION = "Binaries"
LICENSE = "Proprietary"
...
do_install() {
    ...
    install -m 0755 ${WORKDIR}/uaputl.exe ${D}${bindir}

    # create alias for this tool
    install -d ${D}/${base_bindir}
    ln -s ${bindir}/uaputl.exe ${D}${base_bindir}/owasys-uaputl.exe
